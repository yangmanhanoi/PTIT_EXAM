                    ...
                    .map(
                      (questionItem, questionIndex) =>
                        `<div id="list-item-1" class="question-card card">
                          <h5 class="card-header">Câu ${questionIndex + 1}</h5>
                            <div class="card-body">
...
function renderTableResult(examRenderList) {
  examRenderList.forEach((examItem, examItemIndex) => {
    ...
    <td>
    <button id="examBtnModal ${examItemIndex}" type="button" class="btn btn-primary btn-detail-exam" data-bs-toggle="modal"
    ...
    document
      .getElementById("examBtnModal " + examItemIndex)
      .addEventListener("click", () => {
        examItemRenderModal(examItem, examItemIndex);
